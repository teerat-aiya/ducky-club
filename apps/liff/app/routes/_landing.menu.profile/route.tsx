...
export default function ProfileRoute() {
    ...
    achievements: [
      {
        id: 1,
        title: "Early Bird",
        description: "First to arrive 5 times",
        icon: "🏆",
      ...
      },
      {
        id: 3,
        title: "Networker",
        description: "10+ connections made",
        icon: "🤝",
      ...
      },
      {
        id: 4,
        title: "Learner",
        description: "5+ workshops attended",
        icon: "🎓",
  ...
  return (
    <div className="p-4">
      <MainContent profile={profile} user={mockUser} />
    </div>
  );
}
